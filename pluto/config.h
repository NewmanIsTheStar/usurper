...
* Modification Rule 2 -- only add new fields, do not delete, reorder or resize existing fields (except crc)
...
{  
    ...
    char anemometer_remote_ip[32];     
    uint16_t crc;
} NON_VOL_VARIABLES_T_VERSION_12;
